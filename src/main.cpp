...
int main(int argc, char* argv[]) {
  ...
  // Store statistic of radar and laser NIS
  // Threshold
  int threshold = 7.815;
  // Number of radar measurements above threshold
  int radar_above = 0;
  // Number of laser measurements above threadhold
  int laser_above = 0;
  ...
  for (size_t k = 0; k < number_of_measurements; ++k) {
    ...
    if (measurement_pack_list[k].sensor_type_ == MeasurementPackage::LASER) {
      ...
      // Update NIS statistic
      total_laser++;
      if (ukf.NIS_laser_ > threshold) {
        laser_above++;
      }
  ...
  // Output NIS statistics
  cout << "Laser NIS statistic: " << (double) laser_above / total_laser << endl;
  cout << "Radar NIS statistic: " << (double) radar_above / total_laser << endl;
